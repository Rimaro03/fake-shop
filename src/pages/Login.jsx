...
const Login = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://fakestoreapi.com/users")
      .then((res) => res.json())
      .then((json) =>
        window.localStorage.setItem("userList", JSON.stringify(json))
      );
  }, []);
  ...
  return (
    <FormContainer>
      ...
      <Typography variant={"caption"} sx={{}}>
        Don't have an account? Check the{" "}
        <Link href="https://fakestoreapi.com/users" color={palette.black.main}>
          {" "}
          account list!
        </Link>
      </Typography>
